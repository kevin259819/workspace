        ...
        contenedor.innerHTML = `
            ...
            <div class="row">
                <div class="col-1">
                    <button class="btnEliminar" id="btnVolver">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16" id="iconoVolver">
            ...
            <div class="row"> 
                <div class="col-6" style="display:flex; justify-content:center; align-items:center;">
                    ...
                    <input type="text" class="inputCantidad justify-content:center" size="1" value="${producto.cantidad}">
                    <button id="${producto.id}-">
